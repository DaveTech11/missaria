...
## V7 Hermes-style capabilities
Optional environment flags:
- `ARIA_AGENT_WORKSPACE=/absolute/path/to/workspace`
- `ARIA_ENABLE_LOCAL_TOOLS=false` by default
- `ARIA_ENABLE_ADVANCED_INTEGRATIONS=false` by default

Provider-specific web/image/TTS/browser/video/MCP features require their own credentials or explicitly configured adapters.
