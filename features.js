...
👑 <b>ʙᴀsɪᴄ</b>
• /start — ᴏᴘᴇɴ ᴀʀɪᴀ ʜᴏᴍᴇ
• /menu — ᴏᴘᴇɴ ᴛʜᴇ ғᴜʟʟ ᴍᴇɴᴜ
• /profile — ᴠɪᴇᴡ ʏᴏᴜʀ ᴘʀᴏғɪʟᴇ
• /usage — ᴠɪᴇᴡ ʏᴏᴜʀ ᴜsᴀɢᴇ

💬 <b>ᴀɪ</b>
• /ai — ᴄʜᴏᴏsᴇ ᴀɪ ᴍᴏᴅᴇ
• /clear — ᴄʟᴇᴀʀ ᴄʜᴀᴛ ʜɪsᴛᴏʀʏ
• /agent — sᴛᴀʀᴛ ᴛʜᴇ ᴀɪ ᴀɢᴇɴᴛ
• /coding — ᴄᴏᴅɪɴɢ ᴀssɪsᴛᴀɴᴛ
...
• /download — ᴅᴏᴡɴʟᴏᴀᴅ ᴛᴏᴏʟs

━━━━━━━━━━━━━━━━━━

✨ <i>ᴜsᴇ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ᴛᴏ ɴᴀᴠɪɢᴀᴛᴇ.</i>
</blockquote>`;
        ...
        reply_markup: {
            inline_keyboard: [
                [
                    ...
                    { text: "🧠 ᴀɪ ᴍᴏᴅᴇ", callback_data: "aria_mode_open", style: "primary" },
                    { text: "👤 ᴘʀᴏғɪʟᴇ", callback_data: "v10_profile", style: "primary" }
                ],
                [
                    { text: "🎨 ɪᴍᴀɢᴇ", callback_data: "v10_image", style: "success" },
                    { text: "🎵 ᴍᴜsɪᴄ", callback_data: "v10_music", style: "primary" },
                    { text: "🎬 ᴍᴏᴠɪᴇ", callback_data: "v10_movies", style: "primary" }
                ],
                [
                    { text: "‹ ᴘʀᴇᴠ", callback_data: "menu_page_1", style: "primary" },
                    { text: "🌸 ʜᴏᴍᴇ", callback_data: "menu_back", style: "success" },
                    { text: "ɴᴇxᴛ ›", callback_data: "menu_page_2", style: "success" }
                ]
            ]
        },
        reply_to_message_id: msg.message_id
